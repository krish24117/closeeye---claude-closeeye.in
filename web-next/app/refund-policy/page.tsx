...
const TITLE = 'Refund & Cancellation Policy — Close Eye'
const DESCRIPTION = 'Cancellation and refund policy for Close Eye companion visits and monthly plans.'

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: '/refund-policy' },
  openGraph: { title: TITLE, description: DESCRIPTION, url: '/refund-policy', images: [{ url: `/api/og?title=${encodeURIComponent(TITLE)}`, width: 1200, height: 630 }] },
