...
const TITLE = 'Contact — Close Eye'
const DESCRIPTION = 'Get in touch with the Close Eye team on WhatsApp or email — we reply within a few hours.'

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: '/contact' },
  openGraph: { title: TITLE, description: DESCRIPTION, url: '/contact', images: [{ url: `/api/og?title=${encodeURIComponent(TITLE)}`, width: 1200, height: 630 }] },
    ...
    <main>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="mt-10 flex gap-4 flex-wrap">
          <Link href="/services" className="text-sm text-green-700 hover:underline">View our services →</Link>
          <Link href="/faq" className="text-sm text-gray-400 hover:text-green-700">FAQ →</Link>
        </div>
      </section>
    </main>
  )
