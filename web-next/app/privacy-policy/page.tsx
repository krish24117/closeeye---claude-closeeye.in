...
const TITLE = 'Privacy Policy — Close Eye'
const DESCRIPTION = "How Close Eye collects, uses, and protects your family's data."

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: '/privacy-policy' },
  openGraph: { title: TITLE, description: DESCRIPTION, url: '/privacy-policy', images: [{ url: `/api/og?title=${encodeURIComponent(TITLE)}`, width: 1200, height: 630 }] },
