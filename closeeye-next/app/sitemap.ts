...
const INDIA_PAGES: Entry[] = [
  ...
  { path: '/trust/emergency', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/trust/sample-report', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/trust/stories', priority: 0.4, changeFrequency: 'monthly' },
