...
export default function FamilyBookPage() {
  ...
  async function confirm() {
    setError('')
    if (!member) return setError('Please choose who this visit is for.')
  ...
  return (
    <div className="mx-auto flex w-full max-w-lg flex-col gap-8">
      ...
      <Button size="lg" className="w-full sm:w-auto sm:self-start" disabled={!valid || busy} onClick={confirm}>
