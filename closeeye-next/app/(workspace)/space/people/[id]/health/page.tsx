...
/**
 * Phase 4 · People — Health & care profile (Owner: People, /space/people/[id]/health). Ported
 * from /family/members/[id]/health: the same fetch/upsertElderProfile, the same load-safety (a
 * failed load never falls through to a blank form that a save could wipe), the same photo-consent.
 * Only navigation is re-homed to the Person Space. The family route redirects here once live.
 */
