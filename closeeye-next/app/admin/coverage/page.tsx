...
export default function CoveragePage() {
  ...
  if (error) return <div className="flex flex-col gap-8"><h1 className="text-h2">Coverage</h1><ErrorState title="Couldn’t load Coverage" message="A connection error — please retry." onRetry={load} /></div>
