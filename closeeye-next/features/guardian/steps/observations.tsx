    ...
    <div className="flex flex-col gap-5 py-2">
      ...
      <label className="rounded-lg border border-line bg-card p-5 shadow-sm">
        <span className="flex items-center gap-2 text-caption font-semibold uppercase tracking-widest text-muted">
          <Flag className="h-4 w-4 text-green" strokeWidth={1.75} /> Anything for your Presence Manager?
        </span>
        ...
        <textarea
          ...
          rows={2}
          placeholder="Anything you’d like your Presence Manager to follow up on"
