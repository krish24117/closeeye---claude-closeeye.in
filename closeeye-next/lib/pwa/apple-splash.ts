/**
 * Apple touch startup images (iOS PWA splash). Generated by scripts/generate-splash-og.mjs.
 * Wired into app/layout.tsx appleWebApp.startupImage.
 */
export const APPLE_SPLASH: { url: string; media: string }[] = [
